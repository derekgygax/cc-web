...
public class Partner {
	...
	public HashMap<String, String> createWithToken(String data, String coupleRequestToken, HttpServletRequest request) throws IOException {
		HashMap<String, String> params = new HashMap<String, String>();
		params.put("data", data);
		params.put("coupleRequestToken", coupleRequestToken);
		HashMap<String, String> statusAndNewPartnerId = new Api("create-couple-with-token", false, request).postWith(new String[0], params);
		return statusAndNewPartnerId;
	}
	...
	public HashMap<String, String> getAsHashMap(){
		...
		partner.put("verifiedEmail", String.valueOf(this.verifiedEmail));
		return partner;
	}
