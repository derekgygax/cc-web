...
public class Utils {
	...
	public static void startSession(String username, String password, String partnerId, String coupleId, HttpServletRequest request){
		HashMap<String, String> userLoggedIn = new HashMap<String, String>();
		userLoggedIn.put("username", username);
