...
public class Api {
	...
	private String ccHost = "http://18.216.134.146:8080/cc-server/";
	...
	public Api(String servlet, boolean needsAuth, HashMap<String, String> userPassword){
		...
		this.ccHost = Config.getProperty("API_URL");
		this.needsAuth = needsAuth;
		this.url = new StringBuffer(ccHost);
		this.url.append(servlet);
		this.username = userPassword.get("username");
		this.password = userPassword.get("password");
	}
	...
	public Api(String servlet, boolean needsAuth, HttpServletRequest request){
		if (needsAuth){
			...
			this.username = userLoggedIn.get("username");
