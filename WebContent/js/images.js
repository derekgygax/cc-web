...
//				Need to do this still!!!
	...
	$("body").on("submit", ".uploadImagesForm", function(event){
		...
		var ele = $(".uploadImagesForm .image_upload");
		
		$(ele).each(function() {
			var element = $(this)[0];
			var imgNumber = element.name;
		...
		if('image_0' in imagesAndDimensions){
			if(imagesAndDimensions.image_0.size){
		...
		console.log(imagesAndDimensions);
